...
import * as person from '../controllers/people'
...
//persons
router.get('/events/:id_event/groups/:id_group/people', auth.validate, person.getAll)
router.get('/events/:id_event/groups/:id_group/people/:id', auth.validate, person.getPerson)
router.post('/events/:id_event/groups/:id_group/people', auth.validate, person.addPerson)
router.put('/events/:id_event/groups/:id_group/people/:id', auth.validate, person.updatePerson)
router.delete('/events/:id_event/groups/:id_group/people/:id', auth.validate, person.deletePerson)
